          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (Platform.isLinux) ...[
                      _buildInstallStep(
                        context, l10n.onFedora, l10n.openTerminalAndRun,
                        'sudo dnf install ffmpeg ffmpeg-devel',
                        onTap: _launchFedoraGuide, l10n: l10n,
                      ),
                      const SizedBox(height: 16),
                      _buildInstallStep(
                        context, l10n.onUbuntuDebian, l10n.openTerminalAndRun,
                        'sudo apt install ffmpeg', l10n: l10n,
                      ),
                      const SizedBox(height: 16),
                    ],
                    ...
                    if (Platform.isWindows) ...[
                      _buildInstallStep(
                        context, l10n.onWindows, l10n.openTerminalAndRun,
                        'winget install ffmpeg', l10n: l10n,
                      ),
                      const SizedBox(height: 16),
                      _buildInstallStep(
                        context, l10n.onWindows, l10n.downloadFromFfmpeg,
                        'Scarica da https://ffmpeg.org/download.html',
                        onTap: _launchFFmpegWebsite, l10n: l10n,
                      ),
                      const SizedBox(height: 16),
                    ],

                    _buildInstallStep(
                      context, l10n.onMacOS, l10n.useHomebrew,
                      'brew install ffmpeg', l10n: l10n,
                    ),
                  ],
                ),
              ),
            ...
            Row(
              ...
              children: [
                ...
                if ((Platform.isLinux || Platform.isWindows) &&
                    (widget.dependencyStatus['needsUpdate'] == true || widget.dependencyStatus['available'] != true)) ...[
